...
def setup():
    ...
    url = 'https://computos2025.ine.mx/scjn/nacional/candidatura'
    driver.get(url)
...
def pytest_html_report_title(report):  
    report.title = "Reporte de Pruebas de Publicación Cómputos Distritales Ministro(a) SCJN"  
  
def pytest_configure(config):  
    config.stash[metadata_key]["Project"] = "Pruebas Sitio Publicación Cómputos Distritales Ministro(a) SCJN"  